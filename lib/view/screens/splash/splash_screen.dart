...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void _route() {
    ...
    Provider.of<SplashProvider>(context, listen: false)
      ...
      if (isSuccess) {
        print(
            '---------------->${Provider.of<SplashProvider>(context, listen: false).configModel.maintenanceMode}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        //     children: [
        //       ClipRRect(borderRadius: BorderRadius.circular(10), child: Image.asset(Images.splash, width: 150)),
        //       // SizedBox(height: 20),
